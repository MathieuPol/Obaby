 ...
 */
final class Version20220804070814 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE practice (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(127) NOT NULL, content LONGTEXT NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, status SMALLINT NOT NULL, slug VARCHAR(255) NOT NULL, picture VARCHAR(50) DEFAULT NULL, INDEX IDX_7FEC344E12469DE2 (category_id), INDEX IDX_7FEC344EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
